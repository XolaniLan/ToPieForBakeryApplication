                ...
                <div class="container">
                    <div class="signup-content">
                        <div class="signup-form">
                            ...
                            <form method="POST" action="UserController" class="register-form" id="register-form">
                                ...
                                <div class="form-group">
                                    <label for="contactNumber"><i class="zmdi zmdi-email"></i></label> 
                                    <input type="text"
                                           name="contactNumber" id="contactNumber" placeholder="Your Contact Number" />
                                </div>
                                <div class="form-group">
                        ...
                        <div class="signup-image">
                            ...
                            <p>
                                ...
                                <a href="login.jsp" class="signin-image-link"> Sign in</a>
                            </p>
