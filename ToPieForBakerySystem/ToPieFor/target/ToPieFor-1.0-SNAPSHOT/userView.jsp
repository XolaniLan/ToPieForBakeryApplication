                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><a href="addAdmin.jsp" class="btn btn-sm btn-primary">Add Admin</a></td>
                                                <td><a href="register.jsp" class="btn btn-sm btn-primary">Add User</a></td>
                                                <th scope="col"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=role%></td>
                                                <td><%=active%></td>
                                                <td><a href='editUser.jsp' >
                                                        <a href="UserController?act=userbyusername&username=<%=u.getUsername()%>" class='btn btn-sm btn-primary'>Edit</a></td>
                                                <td>
                                                    <a href='UserController?act=activate&username=<%=u.getUsername()%>&isActive=<%=true%>' class='btn btn-sm btn-primary' >Activate</a></td>
                                                <td>
                                                    <a href='UserController?act=activate&username=<%=u.getUsername()%>&isActive=<%=false%>' class='btn btn-sm btn-primary' >Deactivate</a></td>
                                            </tr>
                                            <%      }
                                                }
                                            %>     
