                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td><a href="addCategory.jsp" class="btn btn-sm btn-primary">Add</a></td>
                                                    <th scope="col"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= active%></td>
                                                    <td>
                                                        <a href='CategoryController?act=categorybyid&categoryId=<%=c.getCategoryId()%>' class='btn btn-sm btn-primary' >Edit</a></td>
                                                    <td>
                                                        <a href='CategoryController?act=activate&categoryId=<%=c.getCategoryId()%>&isActive=<%=true%>' class='btn btn-sm btn-primary' >Activate</a></td>
                                                    <td>
                                                        <a href='CategoryController?act=activate&categoryId=<%=c.getCategoryId()%>&isActive=<%=false%>' class='btn btn-sm btn-primary' >Deactivate</a></td>
                                                </tr>
                                                <%     }
                                                    }
                                                %>
