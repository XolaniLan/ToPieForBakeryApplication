                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><a href="addRecipe.jsp" class="btn btn-sm btn-primary">Add</a></td>
                                                <th scope="col"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            %>
                                            <tr> 
                                                <th scope'row'><%=r.getRecipeName()%></th>
                                                <td><%=r.getDescription()%></td>
                                                <td><%=active%></td>
                                                <td>
                                                    <a href='RecipeController?act=recipeingredient&recipeId=<%=r.getRecipeId()%>' class='btn btn-sm btn-primary' >Manage Ingredients</a></td>                            
                                                <td>
                                                    <a href='RecipeController?act=recipebyid&recipeId=<%=r.getRecipeId()%>' class='btn btn-sm btn-primary' >Edit</a></td>   
                                                <td>
                                                    <a href='RecipeController?act=activate&recipeId=<%=r.getRecipeId()%>&isActive=<%=true%>' class='btn btn-sm btn-primary' >Activate</a></td>
                                                <td>
                                                    <a href='RecipeController?act=activate&recipeId=<%=r.getRecipeId()%>&isActive=<%=false%>' class='btn btn-sm btn-primary' >Deactivate</a></td>
                                            </tr>
                                            </tr>
                                            <% }
                                                }
